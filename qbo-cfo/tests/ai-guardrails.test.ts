...
function payload(): ReportPayload {
  ...
  return {
    ...
    metrics: { ...base, companyId: 'c', period } as unknown as ReportPayload['metrics'],
    comparisons: { priorMonth: null, sameMonthLastYear: null, yearToDate: null, priorYearToDate: null, trailing12: null },
    ...
    dataQuality: { checks: [], confidence: 'high', reasons: [] },
  };
}
